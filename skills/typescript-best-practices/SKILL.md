...
Use TypeScript's type system to encode domain invariants. Read
[type-system discipline](references/type-system-discipline.md) when modeling
domain states or reviewing unsafe types. When the code accepts external data or
mixes business logic with I/O, also read
[boundary discipline](references/boundary-discipline.md).
