...
Code examples for each rule in `SKILL.md`. For the language-agnostic reasoning
behind them, see [type-system discipline](type-system-discipline.md) and
...
Validate once where data crosses in; trust domain types inside. See
[boundary discipline](boundary-discipline.md).
